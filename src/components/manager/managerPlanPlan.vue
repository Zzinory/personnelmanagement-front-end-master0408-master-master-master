<template>
  <div>
    ...
    <el-table ref="filterTable" :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="op" label="编辑" width="180">
    ...
    <el-dialog
      ...
      width="90%"
    >
      <el-form ref="form" :model="publishAnnouncement" label-width="80px">
        ...
        <el-form-item label="内容">
          <el-input
            type="textarea"
            :rows="10"
            v-model="publishAnnouncement.desc"
          ></el-input>
        </el-form-item>
